...
const words = [
    ...
    { en: "pretty", ja: "かなり" },
    { en: "last", ja: "最後に" },
    { en: "just", ja: "ちょうど、たった今" },
    { en: "again", ja: "ふたたび、また" },
    { en: "now", ja: "今、現在" },
    { en: "then", ja: "その時、それから、それでは" },
    { en: "sometime", ja: "いつか、そのうち" },
    { en: "usually", ja: "いつもは、普通" },
    { en: "often", ja: "しばしば、たびたび" },
    { en: "soon", ja: "まもなく、すぐ" },
    { en: "off", ja: "離れて、去って、脱いで、切れて" },
    { en: "over", ja: "上方に、越えて、一面、終わって" },
    { en: "also", ja: "～もまた" },
    { en: "only", ja: "ただ…だけ" },
    { en: "well", ja: "上手に、上手く" },
    { en: "about", ja: "およそ、約なんとか" },
    { en: "", ja: "" },
    { en: "", ja: "" },
    { en: "", ja: "" },
    { en: "", ja: "" },
