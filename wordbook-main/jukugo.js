...
const words = [
    ...
    { en: "fall down", ja: "～が転ぶ・倒れる" },
    { en: "require A to do", ja: "Aに～するようにと要求する" },
    { en: "in respect of", ja: "～の点では" },
    { en: "with respect to", ja: "～に関して" },
    { en: "take notice of", ja: "～に注目する" },
    { en: "be born", ja: "生まれる" },
    { en: "earn a living", ja: "生計を立てる" },
    { en: "hang up", ja: "電話を切る" },
    { en: "hold on", ja: "電話を切らないでおく、しばらく待つ" },
    { en: "raise a flag", ja: "旗を揚げる" },
    { en: "be fed up with...", ja: "…に飽き飽きしている" },
    { en: "for lack of", ja: "～の不足から" },
    { en: "eat out", ja: "外食する" },
    { en: "think about of", ja: "～について考える" },
    { en: "try to do", ja: "～しようと努力する" },
    { en: "try on", ja: "試着する" },
    { en: "want to do", ja: "～したい" },
    { en: "write a letter to ~", ja: "～に手紙を書く" },
    { en: "go to bed", ja: "寝る" },
    { en: "by car", ja: "車で" },
    { en: "do one's homework", ja: "宿題をする" },
    { en: "take a photo", ja: "写真を撮る" },
    { en: "go to the movies", ja: "映画を見に行く" },
    { en: "at the age of~", ja: "～歳で" },
    { en: "for example", ja: "例えば" },
    { en: "have a good time", ja: "楽しく過ごす" },
    { en: "be good at~", ja: "～が得意である" },
    { en: "", ja: "" },
    { en: "", ja: "" },
    { en: "", ja: "" },
    { en: "", ja: "" },
