...
const words = [
    ...
    { en: "arrival", ja: "到着" },
    { en: "goal", ja: "目標、ゴール、決勝点" },
    { en: "following", ja: "次のもの" },
    { en: "minute", ja: "（時間・角度の）分、ちょっとの間、<~S>議事録" },
    { en: "article", ja: "（～についての）記事、品物" },
    { en: "rent", ja: "賃貸料、家賃" },
    { en: "employee", ja: "従業員" },
    { en: "credit", ja: "信用取引、信用" },
    { en: "project", ja: "計画、事業" },
    { en: "stock", ja: "在庫品、株式" },
    { en: "foundation", ja: "基礎、根拠、財団" },
    { en: "contact", ja: "連絡先、接触" },
    { en: "instruction", ja: "<~s>仕様説明書、指示、指導" },
    { en: "issue", ja: "問題点、…号" },
    { en: "property", ja: "財産、資産、特性" },
    { en: "security", ja: "安全・保障、警備" },
    { en: "application", ja: "応募、アプリケーション、応用" },
    { en: "reseach", ja: "研究、調査" },
    { en: "advantage", ja: "利点、利用する" },
    { en: "average", ja: "平均値、平均して" },
    { en: "major", ja: "専攻科目" },
    { en: "majority", ja: "過半数、多数派" },
    { en: "income", ja: "収入、所得" },
    { en: "loan", ja: "貸付、貸出" },
    { en: "chart", ja: "図、表" },
    { en: "director", ja: "取締役、監督" },
    { en: "file", ja: "ファイル" },
    { en: "illness", ja: "病気" },
    { en: "item", ja: "項目、品目、品物、1項目" },
  ];
